                                        ...
                                        <div class="p-2">
                                            <form method="POST" action="{{ route('password.update') }}">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" class="form-control password-input @error('email') is-invalid @enderror"
                                                        name="email" value="{{ $email ?? old('email') }}" id="email" placeholder="Enter your email" required>
                                                    @error('email')
