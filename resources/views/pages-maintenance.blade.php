                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-xl-8 col-sm-5 col-8">
                                                    <img src="https://img.themesbrand.com/judia/auth/maintenance.png" alt="" class="img-fluid">
                                                </div>
                                            </div>
                                            <div class="mt-4 pt-3">
                                                <a href="index" class="btn btn-primary"><i class="bi bi-house me-1"></i> Back to Home</a>
                                            </div>
                                        </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
