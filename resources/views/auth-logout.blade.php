                                    ...
                                    <div class="card-body py-5 d-flex justify-content-between flex-column h-100 position-relative gap-4">
                                        ...
                                        <div class="text-center">
                                            <p class="text-white text-opacity-75 mb-0 mt-3">
                                                &copy; <script>document.write(new Date().getFullYear())</script> Judia. Crafted with <i class="bi bi-heart-fill text-danger"></i> by <a href="#!" class="text-white">Themesbrand</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-0 border-0 shadow-none mb-0">
                                    <div class="card-body p-sm-5 m-lg-4">
                                        ...
                                        <div class="mt-4 pt-2 text-center">
                                            ...
                                            <p class="text-muted">Thank you for using <span class="fw-semibold">judia</span> admin template</p>
                                            <div class="mt-4">
